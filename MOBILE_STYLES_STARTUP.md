...
This document shows all the CSS rules that apply when viewing `index.html` on mobile devices (max-width: 768px and 480px).
...
## Styles from index.html (Inline Styles)
